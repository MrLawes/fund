    ...
    def handle(self, *_, **options):
        data = {
            "[白酒]招商中证白酒指数C": {  # 上涨中
                '三年年化': 268,
                '交易流水': [
                    ('2021-12-10', 500, '2021-12-29'),
                    # ('2021-12-29', 500,), # todo 拆分
                    # ('2021-12-29', 469.96,), # todo 出售
                    # {'交易日期': '2021-12-29', '交易金额': 469.96, "交易类型": '出售', }
                    ('2021-12-29', 30.04,),  # todo 剩余
                ],
                "交易规则": '大于7天：0%',
                "高抛低吸": True,
            },
            ...
            "[军工]易方达国防军工混合": {
                '交易流水': [
                    ('2021-10-23', 10),  # todo 出售
                    ('2021-11-23', 130, '2021-12-20'),

                    # ('2021-12-20', 272), # todo 拆分
                    # ('2021-12-20', 126.14), # todo 出售
                    ('2021-12-20', 145.86),  # todo 剩余
                ],
                '三年年化': 188,
                "交易规则": '大于30天: 0.5%',
            },
